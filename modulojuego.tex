...
\begin{Interfaz}
  ...
  \InterfazFuncion{AgregarPokemon}{\Inout{j}{Juego}, \In{c}{Coordenada}, \In{p}{Pokemon}}{itConj(Pokemon)}
  ...
  \InterfazFuncion{Conectarse}{\Inout{j}{Juego}, \In{id}{Jugador}, \In{c}{Coordenada}}{}
  ...
  \InterfazFuncion{Moverse}{\Inout{j}{Juego}, \In{id}{Jugador}, \In{c}{Coordenada}}{}
  ...
  \InterfazFuncion{posicion}{\In{j}{Juego}, \In{id}{Jugador}}{Coordenada}
  ...
  \InterfazFuncion{posConPokemones}{\In{j}{Juego}}{itConj(Coordenada)}
  [True]
  {$res \igobs posConPokemons(j)$}
  [O(1)]
  [Devuelve un iterador al conjunto de coordenadas en donde hay pokemons]

  \InterfazFuncion{pokemonEnPos}{\In{j}{Juego}, \In{c}{Coordenada}}{Pokemon}
  ...
  \InterfazFuncion{cantMovimientosParaCaptura}{\In{j}{Juego}, \In{c}{Coordenada}}{Nat}
  [c $\in$ posConPokemons(j)]
  ...
  \InterfazFuncion{puedoAgregarPokemon}{\In{j}{Juego}, \In{c}{Coordenada}}{Bool}
  [True]
  ...
  \InterfazFuncion{hayPokemonCercano}{\In{j}{Juego}, \In{c}{Coordenada}}{Bool}
  [True]
  {$res \igobs hayPokemonCercano(c,j)$}
  [$\Theta(1)$] 
  [Devuelve si la coordenada ingresada pertenece al rango de un pokemon salvaje]   

  \InterfazFuncion{posPokemonCercano}{\In{j}{Juego}, \In{c}{Coordenada}}{Coordenada}
  ...
  \InterfazFuncion{entrenadoresPosibles}{\In{c}{Coordenada}, \In{es}{conjLineal(itConj(Jugador))}, \In{j}{Juego}}{itConj(Jugador)}
