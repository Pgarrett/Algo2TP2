...
\begin{Interfaz}
  ...
  \InterfazFuncion{pokemonEnPos}{\In{j}{juego}, \In{c}{Coor}}{itConj(infoPokemon)}
  ...
  \InterfazFuncion{entrenadoresPosibles}{\In{c}{coor}, \In{es}{conjLineal(jugador)}, \In{j}{juego}}{itConj(jugador)}
...
\begin{algorithm}[H]{\textbf{iAgregarPokemon}(\Inout{j}{estr)}, \In{c}{coor)}, \In{p}{pokemon)}) $\to$ $res$ : $itPokemon$}
	\begin{algorithmic}
