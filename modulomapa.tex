...
\begin{Interfaz}
  ...
  \InterfazFuncion{AgregarCoordenada}{\Inout{m}{Mapa}, \In{c}{Coordenada}}{itConj(Coordenada)}
  [$m \igobs m_0$]
  ...
  \InterfazFuncion{Coordenadas}{\In{m}{Mapa}}{itConj(Coordenada)}
  [true]
  ...
  \InterfazFuncion{HayCamino}{\In{c1}{Coordenada}, \In{c2}{Coordenada}, \In{m}{Mapa}}{Bool}
