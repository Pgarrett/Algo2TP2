...
\begin{Representacion}
	...
	\Rep[dicc][d]{(tam(d.posiciones) $\igobs$ (d.ancho x d.largo)) $\yluego$(($\forall c:$ coor) (c $\in$ d.claves) $\Leftrightarrow$ definido?(d.posiciones, n) $\yluego$ d.posiciones[n]$_{1}$ $\igobs$ true)}%\mbox{}
